...
public class activity_update_car extends AppCompatActivity
{
    EditText etModel;
    EditText etPlate;
    EditText etPrice;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        flag = false; //search is not pressed
            ...
            public void onClick(View view)
            {
                ...
                query.addValueEventListener(new ValueEventListener()
                {
                    ...
                    public void onDataChange(@NonNull DataSnapshot ds)
                    {
                        if (ds.getValue() == null)
                        {
                            Toast.makeText(activity_update_car.this,"Not Found",Toast.LENGTH_LONG).show();
                            return;
                        }
                        ...
                        //year=2020, price=3232, model=q1, plate=pp
                        String all[] = s.split(",");

                        year = Integer.parseInt(all[0].substring(all[0].indexOf('=')+1));
                        price = Integer.parseInt(all[1].substring(all[1].indexOf('=')+1));
                        plate = all[3].substring(all[3].indexOf('=')+1);
                        model = all[2].substring(all[2].indexOf('=')+1);
        ...
        updateB.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if (flag == false)
                {
                    Toast.makeText(activity_update_car.this,"You must first press search",Toast.LENGTH_LONG).show();
                    return;
                }
